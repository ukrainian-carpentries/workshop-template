...
<a href="{{site.lc_site}}">Library Carpentry</a> спільноти інструкторів, тренерів, супроводжувачів, помічників і прихильників. Вони мають спільну місію — навчати дослідників базовим навичкам комп'ютерного обчислювання та 
заглибитись у науки про дані.
<p align="center">
  <em>
